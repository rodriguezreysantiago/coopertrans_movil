...
Documento de handoff para retomar trabajo en otra máquina o en una conversación nueva con Claude. Última actualización: **2026-05-09** — Módulo VIAJES Logística completo (alta + edición + liquidación + soft-delete + cálculos POR_VIAJE/POR_TONELADA con 18% comisión chofer) + auditoría sistemática de prolijidad mobile en ~38 archivos UI (login, KPIs, bottom bar, eje dual, mapa flota, sync, telemetría, etc.) + bump **1.0.37+40** publicado a Play Store + GitHub Releases.
