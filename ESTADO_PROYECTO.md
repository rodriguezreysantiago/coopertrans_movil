...
Documento de handoff para retomar trabajo en otra máquina o en una conversación nueva con Claude. Última actualización: **2026-05-10** — Sesión Mac de validación iOS + 2 mejoras UI: (1) fix definitivo overflow KPI cards iOS via FittedBox externo (`2988bbd`); (2) **CustomPainter visual de Gomería** — reemplaza el grid de tiles por un esquema de la unidad desde arriba con cubiertas en posición física real, patrones distintos dirección/tracción, color por % vida (`13736e1`). Build iOS post-rename de carpeta confirmado funcional en simulator iPhone 16 Pro. TestFlight sigue bloqueado por activación de cuenta Apple Developer (>3 días).
