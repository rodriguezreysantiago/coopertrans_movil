...
Documento de handoff para retomar trabajo en otra máquina o en una conversación nueva con Claude. Última actualización: **2026-05-07** — Sesión maratón: módulo Logística + reorg completa de alertas WhatsApp + vigilador de jornada chofer + reorden menú admin + fixes de pipeline release + bump 1.0.23+26 (cosmético por reuso versionCode).
