...
- Coordenadas GPS asociadas a cada evento de alerta (no se rastrea continuamente la ubicación del vehículo, solo el punto donde se generó la alerta).
- Scores de eco-driving agregados por vehículo y por flota.

**Estos datos provienen del vehículo, no del teléfono personal del empleado.** La aplicación no accede a la ubicación del teléfono del empleado.

### 3.5 Datos generados por el uso de la aplicación
...
| Asociar eventos de telemetría con el chofer al volante en ese momento | DNI del chofer + historial de asignaciones |
...
| **WhatsApp** (Meta Platforms, Inc.) | Canal de envío de avisos automáticos al empleado | Número de teléfono y contenido del mensaje |
...
- Los reportes de telemetría histórica se conservan para análisis operativo de la flota.
...
**La aplicación no accede a tu ubicación, contactos, micrófono, ni a tus archivos personales fuera de los que vos elegís compartir.**
