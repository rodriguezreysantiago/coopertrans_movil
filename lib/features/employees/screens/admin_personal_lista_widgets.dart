...
// =============================================================================
//
// NOTA: la card de la lista (`_EmpleadoCard`) y su `_RolBadge` se eliminaron
// en el refactor Núcleo (jun 2026) — la lista ahora usa la fila unificada
// responsive `_FilaPersona` del screen principal para desktop y mobile.
