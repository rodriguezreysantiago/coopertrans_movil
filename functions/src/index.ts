...
// La parte de index que QUEDA (volvo + telemetría) también usa estos
// helpers compartidos — los importamos explícitamente (el `export *` de
// arriba re-exporta hacia afuera, pero no los trae al scope local).
import {
  AsignacionLookup,
